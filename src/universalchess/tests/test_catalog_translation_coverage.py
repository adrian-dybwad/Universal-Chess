...
SAME_IN_EVERY_SHIPPED_LOCALE = {
    ...
    "field.display.pegasus_override_brightness.boardLabel": (
        "DGT Pegasus is a product name and LED is the same initialism in es/fr/de/nl"
    ),
    ...
    "optionSet:timezones_common[America/Chicago]": "spelt the same in es/fr/de/nl",
    "optionSet:timezones_common[America/Denver]": "spelt the same in es/fr/de/nl",
    "optionSet:timezones_common[America/Sao_Paulo]": "spelt the same in es/fr/de/nl",
    "optionSet:timezones_common[Pacific/Auckland]": "spelt the same in es/fr/de/nl",
}
