...
ENGINES = {
    ...
    "koivisto": EngineDefinition(
        ...
        build_commands=[
            ...
            "cd src_files && sed -i "
            "-e 's|#define avx_load_reg  *vldrq_p128|"
    ...
    "maia": EngineDefinition(
        ...
        description="Neural network engine with two weight options: Maia (human-like play at ELO 1100-1900) and Leela (maximum strength). Uses lc0 backend. Build takes 45-60 minutes on Pi.",
    ...
    "drawfish": EngineDefinition(
        ...
        description="A novelty engine inspired by the behaviour of the chess.com 'Zach' bot, but backed by Stockfish so it actively holds equality rather than playing weakly. It never willingly delivers checkmate and steers toward a level position rather than pressing an advantage -- so it is hard to lose to and hard to beat. Configurable: Randomness controls how unpredictably it shuffles among near-equal moves, AvoidCaptures (off by default) makes it shun captures for a more passive, Zach-like shuffle. Requires Stockfish (always installed).",
        repo_url=None,
        build_commands=[],
        binary_path="",
        is_system_package=False,
    ...
    def install_engine(
        ...
        try:
            ...
            if success:
                ...
                # non-fatal -- the binary is installed and seeding stays
