...
class AboutWidget(Widget):
    ...
    def render(self, sprite: Image.Image) -> None:
        ...
        # Draw incomplete shutdown warning if detected. Read from the audit's own
        # module: importing the entry point to reach it would boot the board.
        from universalchess.board import boot_report
        if boot_report.shutdown_was_incomplete():
