...
export const LOCALES = {
  ...
  pl: pl as Bundle, it: it as Bundle, ru: ru as Bundle, tr: tr as Bundle,
};

/** Every locale with a bundle, English included. */
export const SHIPPED = ['en', 'es', 'fr', 'de', 'nl', 'pl', 'it', 'ru', 'tr'] as const;

/** The locales translated away from the English source. */
export const TRANSLATED = ['es', 'fr', 'de', 'nl', 'pl', 'it', 'ru', 'tr'] as const;
