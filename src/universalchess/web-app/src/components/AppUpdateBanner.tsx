...
import { startServiceWorkerUpdates, applyServiceWorkerUpdate } from '../utils/swRegistration';
 ...
 * mid-move. Because the game/visibility inputs are reactive, a banner that is
 * showing during a game auto-applies the moment the game ends or the tab is
 * hidden.
 */
  ...
  return (
    <div className="update-banner" role="status" aria-live="polite">
      ...
      <span className="update-banner__actions">
        <Button variant="success" onClick={reloadNow}>
          {t('appUpdate.reload')}
        </Button>
      </span>
    </div>
